...
import com.example.countriesinfragment.databinding.ItemCountryBinding
import java.util.*

class CountryAdapter(var countries: MutableList<Country>, var myCountry: MyCountry, var context: Context) : RecyclerView.Adapter<CountryAdapter.MyHolder>(), com.example.countriesinfragment.ItemTouchHelper {
